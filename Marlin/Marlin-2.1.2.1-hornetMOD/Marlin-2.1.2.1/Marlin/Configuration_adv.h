...
#define MANUAL_FEEDRATE               \
  {                                   \
    80 * 60, 80 * 60, 50 * 60, 5 * 60 \
  }                            // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel, { 120*60, 120*60, 25*60, 5*60 } artillery official , {50 * 60, 50 * 60, 4 * 60, 2 * 60} configuration official
