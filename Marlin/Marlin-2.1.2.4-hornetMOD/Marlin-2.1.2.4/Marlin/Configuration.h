...
#define STRING_CONFIG_H_AUTHOR "luca-botti, thisiskeithb, Artillery 3D" // Who made the changes.
...
#define MACHINE_UUID "4bdeff7c-7cda-4fc7-8f40-2c091a0428d4"
 ...
 */
#define HOTEND_OVERSHOOT 50 // (°C) Forbid temperatures over MAXTEMP - OVERSHOOT
#define BED_OVERSHOOT 10    // (°C) Forbid temperatures over MAXTEMP - OVERSHOOT
#define COOLER_OVERSHOOT 2  // (°C) Forbid temperatures closer than OVERSHOOT //laser cooler
...
#define DEFAULT_Kd_LIST \
  {                     \
      114.00, 114.00}
#else
#define DEFAULT_Kp 10.58 // 15.25
#define DEFAULT_Ki 0.63  // 0.97
#define DEFAULT_Kd 44.44 // 59.78
#endif
#endif
...
#define DEFAULT_bedKp 143.70 // 120.05 // 92.75
#define DEFAULT_bedKi 25.30  // 20.84  // 15.67
#define DEFAULT_bedKd 544.13 // 460.99 // 366.04
...
#define EXTRUDE_MAXLENGTH (((X_MAX_POS + Y_MAX_POS) / 2) * 4) // circle over all the bed (using avg between xmax and ymax /2 as radius) // 650 default bowden value
 ...
 */
//{ 80.121, 80.121, 400, 445 } artillery official
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
//{ 300, 300, 40, 50 } artillery official
...
#define BED_TRAMMING_INSET_LFRB \
  {                             \
      40, 40, 40, 40}               // (mm) Left, Front, Right, Back insets
 ...
 */
#define Z_PROBE_END_SCRIPT "G0 Z20 F900\nG0 X110 Y180 F2400"
...
// Homing speeds (linear=mm/min, rotational=°/min) {homing_x,homing_y,homing_z}
