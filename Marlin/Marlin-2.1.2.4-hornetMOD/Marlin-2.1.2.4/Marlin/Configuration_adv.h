...
#define CONTROLLER_FAN_PIN FAN2_PIN // Set a custom pin for the controller fan, setted in src/pins/stm32f4/pins_ARTILLERY_RUBY.h
 ...
 * The Timeout Sec can be overridden with M18 and M84. Set to 0 for No Timeout.
 */
...
#define MANUAL_FEEDRATE \
  {                     \
      80 * 60, 80 * 60, 50 * 60, 5 * 60} // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel, { 120*60, 120*60, 25*60, 5*60 } artillery official , {50 * 60, 50 * 60, 4 * 60, 2 * 60} configuration official
...
#define LCD_TIMEOUT_TO_STATUS 30000 // (ms), default 15000 (15 sec)
...
#define SD_FINISHED_RELEASECOMMAND "M18" // Use "M84XYE" to keep Z enabled so your bed stays in place
...
#define MIN_ARC_SEGMENT_MM 0.1 // (mm) Minimum length of each arc segment, 1 artillery offcial
#define MAX_ARC_SEGMENT_MM 1.0 // (mm) Maximum length of each arc segment, deactivated artillery offcial
#define MIN_CIRCLE_SEGMENTS 72 // Minimum number of segments in a complete circle, 24 artillery offcial
